...
## 📢 Features
- Automatically compiles `src/styles/` SCSS files to `public/styles/` CSS.
- Minifies all JavaScript files in `src/js` into a single `main.min.js` in `public/js`.
- Keeps SCSS, JavaScript, and assets well-structured.
